...
This project analyzes how Bitcoin usage grew from 2009 till 2017 by examining block data. Key metrics include transaction volume, block size, empty block rate, block intervals, and the impact of SegWit and halving events.
...
python main.py
    ...
    3. Charts will be saved as PNG files in the current directory.
...
#####Changelog
For a detailed version history, see CHANGELOG.md.
